  ...
  useEffect(() => {
    ...
    if (data) {
      try {
        ...
        console.error("Failed to parse verification token:", {
          data,
    ...
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        if (img.width < 250 || img.height < 250) {
          reject(
            new Error("Image too small. Minimum 250x250 pixels required.")
          );
          return;
        }
        if (img.width > 4000 || img.height > 4000) {
          reject(
            new Error("Image too large. Maximum 4000x4000 pixels allowed.")
          );
          return;
        }
